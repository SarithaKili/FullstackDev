...
const PlaceOrder = () => {
    ...
    const { getTotalCartAmount, placeOrder, cartItems } = useContext(StoreContext);
                    ...
                    <div className="modal-content">
                        ...
                        <ul>
                            {Object.entries(cartItems).map(([id, quantity]) => (
                                <li key={id}>
                                    {quantity} x {id} {/* Replace with actual food item name if available */}
                                </li>
                            ))}
                        </ul>
                        <p>Total: ${getTotalCartAmount() + 5}</p>
